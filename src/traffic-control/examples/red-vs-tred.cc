 ...
 *
 * Authors: Nichit Bodhak Goel <nichit93@gmail.com>
...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Set Queue disc type to RED or TRED", queueDiscType);
  ...
  if ((queueDiscType != "RED") && (queueDiscType != "TRED"))
    {
      std::cout << "Invalid queue disc type: Use --queueDiscType=RED or --queueDiscType=TRED" << std::endl;
      exit (1);
    }
